      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-54 flex-col bg-white shadow-xl">
          ...
          <div className="flex-shrink-0 border-t border-gray-200 p-4">
            ...
            {hasAnyRole([USER_ROLES.MASTER, USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN]) && (
              <button
                onClick={() => {
                  navigate('/select-tenant')
                  setSidebarOpen(false)
                }}
                className="mt-1 flex w-full items-center rounded-md px-2 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-50"
              >
